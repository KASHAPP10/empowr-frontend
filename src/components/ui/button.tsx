  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "gradient-hero text-primary-foreground hover:scale-105 shadow-glow hover:shadow-success font-semibold",
        fintech: "gradient-primary text-primary-foreground hover:bg-primary-glow shadow-soft hover:shadow-glow",
        success: "gradient-success text-success-foreground hover:scale-105 shadow-success",
        glass: "glass text-foreground hover:bg-card/90 backdrop-blur-md border border-border/20",
      },
      size: {
